...
export const GET_TIPO_PAGAMENTOS = 'GET_TIPO_PAGAMENTOS';
...
export const GET_VENDAS = 'GET_VENDAS';

export const CLEAR_COMPRA_ID = 'CLEAR_COMPRA_ID';
export const CLEAR_ITENS = 'CLEAR_ITENS';
